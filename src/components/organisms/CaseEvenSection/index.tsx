...
import { CaseSectionsProps } from "../CaseOddSection"
...
export const CaseEvenSection: React.VFC<CaseSectionsProps> = props => {
  const { title, descriptions, src, comment, alt } = props
